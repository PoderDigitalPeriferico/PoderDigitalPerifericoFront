    ...
    return (
        <>
            ...
            <Grid container>
                ...
                >
                    <Grid className='cointainer' container justifyContent="center" alignItems="center" spacing={2}>
                        <Grid item justifyContent="center" alignItems='center' xs={12}>
                            <Box paddingX={20} className="fundo-transparent">
                                <form onSubmit={onSubmit}>
                                    ...
                                    <Typography className='titulo-put-usuario' variant='h4' align='center'>Atualizar perfil</Typography>
                                    ...
                                    <TextField onChange={(e: ChangeEvent<HTMLInputElement>) => updatedUsuario(e)} id="senha" label="senha" type='password' variant="outlined" name="senha" margin="normal" fullWidth />
                                    <TextField label='Confirmar senha' id='nome' type='password' name='nome' variant='outlined' fullWidth />
